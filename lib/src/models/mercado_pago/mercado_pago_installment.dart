class MercadoPagoInstallment {
  ...
  MercadoPagoInstallment.fromJson( Map<String, dynamic> json ) {
    ...
    installmentRate           = (json['installment_rate'] != null) ? double.parse(json['installment_rate'].toString()) : -1;
    discountRate              = (json['discount_rate'] != null) ? double.parse(json['discount_rate'].toString()) : -1;
